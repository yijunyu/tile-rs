...
//! any future MLIR back end that needs to walk the same `@ascend_tile_*`
...
mod parse_tests {
    ...
    fn is_builtin_helper_matches() {
        ...
        assert!(is_builtin_helper("ascend_tile_load_f32"));
...
module {
  llvm.func @softmax_1d(%arg0: !llvm.ptr<1>, %arg1: !llvm.ptr<1>) attributes {hacc.entry} {
    ...
    %t0 = llvm.call @ascend_tile_load_f32(%arg0, %c1, %c1) : (!llvm.ptr<1>, i32, i32) -> i32
    llvm.return
  }
}
"#;
