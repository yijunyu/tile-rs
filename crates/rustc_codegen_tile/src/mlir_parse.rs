...
module {
  llvm.func @mulmv_q8_0_fused(%arg0: !llvm.ptr<1>, %arg1: !llvm.ptr<1>, %arg2: !llvm.ptr<1>, %arg3: !llvm.ptr<1>) attributes {hacc.entry} {
    ...
    llvm.call @__tile_mul_mv_q8_0_planar_f32(%arg0, %arg1, %arg2, %arg3, %nrows, %bpr, %ncols) : (!llvm.ptr<1>, !llvm.ptr<1>, !llvm.ptr<1>, !llvm.ptr<1>, i32, i32, i32) -> ()
    llvm.return
  }
}
"#;

/// The FUSED Q8_0 mul_mv over ggml's NATIVE INTERLEAVED blocks. Three buffers,
/// not four: the scales ride inside the weight buffer.
pub const MATVEC_Q8_0_INTERLEAVED_MLIR: &str = r#"
module {
  llvm.func @mulmv_q8_0_interleaved(%arg0: !llvm.ptr<1>, %arg1: !llvm.ptr<1>, %arg2: !llvm.ptr<1>) attributes {hacc.entry} {
    ^bb0:
    %nrows = llvm.mlir.constant(4096 : i32) : i32
    %bpr = llvm.mlir.constant(448 : i32) : i32
    %ncols = llvm.mlir.constant(1 : i32) : i32
    llvm.call @__tile_mul_mv_q8_0_interleaved_f32(%arg0, %arg1, %arg2, %nrows, %bpr, %ncols) : (!llvm.ptr<1>, !llvm.ptr<1>, !llvm.ptr<1>, i32, i32, i32) -> ()
    llvm.return
  }
}
"#;

/// The Q8_0 mul_mm over ggml's NATIVE INTERLEAVED blocks. Three buffers.
pub const MATMAT_Q8_0_INTERLEAVED_MLIR: &str = r#"
module {
  llvm.func @mulmm_q8_0_interleaved(%arg0: !llvm.ptr<1>, %arg1: !llvm.ptr<1>, %arg2: !llvm.ptr<1>) attributes {hacc.entry} {
    ^bb0:
    %nrows = llvm.mlir.constant(4096 : i32) : i32
    %bpr = llvm.mlir.constant(448 : i32) : i32
    %ncols = llvm.mlir.constant(512 : i32) : i32
    llvm.call @__tile_mul_mm_q8_0_interleaved_f32(%arg0, %arg1, %arg2, %nrows, %bpr, %ncols) : (!llvm.ptr<1>, !llvm.ptr<1>, !llvm.ptr<1>, i32, i32, i32) -> ()
    llvm.return
  }
}
"#;
...
/// Q4_0 mul_mv over ggml's NATIVE interleaved blocks. Three buffers.
pub const MATVEC_Q4_0_INTERLEAVED_MLIR: &str = r#"
module {
  llvm.func @mulmv_q4_0_interleaved(%arg0: !llvm.ptr<1>, %arg1: !llvm.ptr<1>, %arg2: !llvm.ptr<1>) attributes {hacc.entry} {
    ^bb0:
    %nrows = llvm.mlir.constant(4096 : i32) : i32
    %bpr = llvm.mlir.constant(448 : i32) : i32
    %ncols = llvm.mlir.constant(1 : i32) : i32
    llvm.call @__tile_mul_mv_q4_0_interleaved_f32(%arg0, %arg1, %arg2, %nrows, %bpr, %ncols) : (!llvm.ptr<1>, !llvm.ptr<1>, !llvm.ptr<1>, i32, i32, i32) -> ()
    llvm.return
  }
}
"#;
...
module {
  llvm.func @mulmv_q4_0_fused(%arg0: !llvm.ptr<1>, %arg1: !llvm.ptr<1>, %arg2: !llvm.ptr<1>, %arg3: !llvm.ptr<1>) attributes {hacc.entry} {
    ^bb0:
    %nrows = llvm.mlir.constant(4096 : i32) : i32
    %bpr = llvm.mlir.constant(448 : i32) : i32
    %ncols = llvm.mlir.constant(1 : i32) : i32
    llvm.call @__tile_mul_mv_q4_0_planar_f32(%arg0, %arg1, %arg2, %arg3, %nrows, %bpr, %ncols) : (!llvm.ptr<1>, !llvm.ptr<1>, !llvm.ptr<1>, !llvm.ptr<1>, i32, i32, i32) -> ()
    llvm.return
  }
}
"#;
