...
//
// All buffer parameters (UbBuf) are buffer IDs returned by ascend_buf_alloc().
...
pub unsafe fn relu_f32(dst: UbBuf, src: UbBuf, n: u32) {
    unsafe {
        crate::ascend_maxs_f32(dst, src, 0.0f32, n);
    }
}
...
pub unsafe fn leaky_relu_f32(
    ...
    unsafe {
        ...
        // neg = min(x, 0)
        crate::ascend_mins_f32(*neg, *src, 0.0f32, n);
        crate::ascend_pipe_barrier();
        // neg = alpha * min(x, 0)
        crate::ascend_muls_f32(*neg, *neg, alpha, n);
        crate::ascend_pipe_barrier();
        // src = max(x,0) + alpha*min(x,0) — ALL SEPARATE (src != dst != neg)
        crate::ascend_add_f32(*src, *dst, *neg, n);
        crate::ascend_pipe_barrier();
        // dst = result
        crate::ascend_muls_f32(*dst, *src, 1.0f32, n);
    }
}
...
pub unsafe fn sigmoid_f32(dst: UbBuf, src: UbBuf, n: u32) {
    unsafe {
        ...
        crate::ascend_pipe_barrier();
        // dst = exp(-x)
        crate::ascend_exp_f32(dst, dst, n);
        crate::ascend_pipe_barrier();
        // dst = 1 + exp(-x)
        crate::ascend_adds_f32(dst, dst, 1.0f32, n);
        crate::ascend_pipe_barrier();
        // dst = 1 / (1 + exp(-x))
        crate::ascend_reciprocal_f32(dst, dst, n);
    }
}
...
pub unsafe fn tanh_f32(dst: UbBuf, src: UbBuf, n: u32) {
    unsafe {
        // dst = 2x
        crate::ascend_muls_f32(dst, src, 2.0f32, n);
        crate::ascend_pipe_barrier();
        // dst = -2x
        crate::ascend_muls_f32(dst, dst, -1.0f32, n);
        crate::ascend_pipe_barrier();
        // dst = exp(-2x)
        crate::ascend_exp_f32(dst, dst, n);
        crate::ascend_pipe_barrier();
        ...
        crate::ascend_pipe_barrier();
        // dst = 2 * sigmoid(2x)
        crate::ascend_muls_f32(dst, dst, 2.0f32, n);
        crate::ascend_pipe_barrier();
...
pub unsafe fn gelu_f32(dst: &mut UbBuf, src: &UbBuf, tmp: &mut UbBuf, n: u32) {
    unsafe {
        ...
        crate::ascend_muls_f32(*tmp, *src, -1.702f32, n);
        crate::ascend_pipe_barrier();
        // tmp = exp(-1.702 * x)
        crate::ascend_exp_f32(*tmp, *tmp, n);
        crate::ascend_pipe_barrier();
        // tmp = 1 + exp(-1.702 * x)
        crate::ascend_adds_f32(*tmp, *tmp, 1.0f32, n);
        crate::ascend_pipe_barrier();
        // tmp = 1 / (1 + exp(-1.702 * x)) = sigmoid(1.702 * x)
        crate::ascend_reciprocal_f32(*tmp, *tmp, n);
        crate::ascend_pipe_barrier();
        // dst = x * sigmoid(1.702 * x)
        crate::ascend_mul_f32(*dst, *src, *tmp, n);
    }
}
...
pub unsafe fn gelu_f16(dst: &mut UbBuf, src: &UbBuf, tmp: &mut UbBuf, n: u32) {
    unsafe {
        crate::ascend_muls_f16(*tmp, *src, -1.702f32, n);
        crate::ascend_pipe_barrier();
        crate::ascend_exp_f16(*tmp, *tmp, n);
        crate::ascend_pipe_barrier();
        crate::ascend_adds_f16(*tmp, *tmp, 1.0f32, n);
        crate::ascend_pipe_barrier();
        crate::ascend_reciprocal_f16(*tmp, *tmp, n);
        crate::ascend_pipe_barrier();
        crate::ascend_mul_f16(*dst, *src, *tmp, n);
    }
}
...
pub unsafe fn softplus_f32(dst: UbBuf, src: UbBuf, n: u32) {
    unsafe {
        // dst = exp(x)
        crate::ascend_exp_f32(dst, src, n);
        crate::ascend_pipe_barrier();
        // dst = 1 + exp(x)
        crate::ascend_adds_f32(dst, dst, 1.0f32, n);
        crate::ascend_pipe_barrier();
        // dst = ln(1 + exp(x))
        crate::ascend_ln_f32(dst, dst, n);
    }
}
...
pub unsafe fn hardtanh_f32(dst: UbBuf, src: UbBuf, min_val: f32, max_val: f32, n: u32) {
    unsafe {
        // dst = max(x, min_val)
        crate::ascend_maxs_f32(dst, src, min_val, n);
        crate::ascend_pipe_barrier();
        // dst = min(dst, max_val) = clamp(x, min_val, max_val)
        crate::ascend_mins_f32(dst, dst, max_val, n);
    }
}
...
pub unsafe fn selu_f32(dst: &mut UbBuf, src: &mut UbBuf, tmp: &mut UbBuf, n: u32) {
    unsafe {
        ...
        // tmp = exp(x)
        crate::ascend_exp_f32(*tmp, *src, n);
        crate::ascend_pipe_barrier();
        // tmp = exp(x) - 1
        crate::ascend_adds_f32(*tmp, *tmp, -1.0f32, n);
        crate::ascend_pipe_barrier();
        // tmp = alpha * (exp(x) - 1)
        crate::ascend_muls_f32(*tmp, *tmp, alpha, n);
        crate::ascend_pipe_barrier();
        // tmp = min(0, alpha*(exp(x)-1))
        crate::ascend_mins_f32(*tmp, *tmp, 0.0f32, n);
        crate::ascend_pipe_barrier();
        ...
        crate::ascend_add_f32(*src, *dst, *tmp, n);
        crate::ascend_pipe_barrier();
        // dst = scale * result
        crate::ascend_muls_f32(*dst, *src, scale, n);
    }
}
...
pub unsafe fn softmax_f32(dst: &mut UbBuf, src: &mut UbBuf, work: &mut UbBuf, n: u32) {
    unsafe {
        ...
        let max_val = crate::ascend_reduce_max_f32(*work, *src, *dst, n);
        crate::ascend_pipe_barrier();

        // Step 2: dst = x - max(x)
        crate::ascend_adds_f32(*dst, *src, -max_val, n);
        crate::ascend_pipe_barrier();
        ...
        crate::ascend_muls_f32(*src, *dst, 1.0f32, n);
        crate::ascend_pipe_barrier();

        // Step 4: sum = reduce_sum(exp(x - max(x))) — dst may be corrupted, src is safe
        let sum = crate::ascend_reduce_sum_f32(*work, *src, *dst, n);
        crate::ascend_pipe_barrier();

        // Step 5: normalize from saved copy
        let inv_sum = 1.0f32 / sum;
        crate::ascend_muls_f32(*dst, *src, inv_sum, n);
    }
}
...
pub unsafe fn layernorm_f32(dst: &mut UbBuf, src: &UbBuf, work: &mut UbBuf, n: u32, eps: f32) {
    unsafe {
        ...
        // Step 2: dst = x - mean
        crate::ascend_adds_f32(*dst, *src, -mean, n);
        crate::ascend_pipe_barrier();

        // Step 3: work = (x - mean)^2
        crate::ascend_mul_f32(*work, *dst, *dst, n);
        crate::ascend_pipe_barrier();
...
pub unsafe fn reduce_mean_f32(dst: &mut UbBuf, src: &UbBuf, work: &mut UbBuf, n: u32) -> f32 {
    unsafe {
        let sum = crate::ascend_reduce_sum_f32(*dst, *src, *work, n);
        sum / (n as f32)
    }
}
...
pub unsafe fn hardsigmoid_f32(dst: UbBuf, src: UbBuf, n: u32) {
    unsafe {
        // dst = x / 6
        crate::ascend_muls_f32(dst, src, 1.0f32 / 6.0f32, n);
        crate::ascend_pipe_barrier();
        // dst = x/6 + 0.5
        crate::ascend_adds_f32(dst, dst, 0.5f32, n);
        crate::ascend_pipe_barrier();
        // dst = max(0, dst)
        crate::ascend_maxs_f32(dst, dst, 0.0f32, n);
        crate::ascend_pipe_barrier();
        // dst = min(1, dst) = clamp(x/6 + 0.5, 0, 1)
        crate::ascend_mins_f32(dst, dst, 1.0f32, n);
    }
}
...
pub unsafe fn softsign_f32(dst: &mut UbBuf, src: &UbBuf, tmp: &mut UbBuf, n: u32) {
    unsafe {
        // tmp = |x|
        crate::ascend_abs_f32(*tmp, *src, n);
        crate::ascend_pipe_barrier();
        // tmp = 1 + |x|
        crate::ascend_adds_f32(*tmp, *tmp, 1.0f32, n);
        crate::ascend_pipe_barrier();
...
pub unsafe fn gelu_tanh_f32(dst: &mut UbBuf, src: &UbBuf, tmp: &mut UbBuf, n: u32) {
    unsafe {
        ...
        // tmp = x^2
        crate::ascend_mul_f32(*tmp, *src, *src, n);
        crate::ascend_pipe_barrier();
        // dst = x^3 = x^2 * x — all separate (dst != tmp != src)
        crate::ascend_mul_f32(*dst, *tmp, *src, n);
        crate::ascend_pipe_barrier();
        // dst = 0.044715 * x^3
        crate::ascend_muls_f32(*dst, *dst, 0.044715f32, n);
        crate::ascend_pipe_barrier();
        // tmp = x + 0.044715 * x^3 — all separate (tmp != src != dst)
        crate::ascend_add_f32(*tmp, *src, *dst, n);
        crate::ascend_pipe_barrier();
        // tmp = sqrt(2/pi) * (x + 0.044715 * x^3)
        crate::ascend_muls_f32(*tmp, *tmp, sqrt_2_over_pi, n);
        crate::ascend_pipe_barrier();
        // tmp = tanh(...)
        tanh_f32(*tmp, *tmp, n);
        crate::ascend_pipe_barrier();
        ...
        crate::ascend_pipe_barrier();
        // dst = 0.5 * x * (1 + tanh(...))
        crate::ascend_muls_f32(*dst, *dst, 0.5f32, n);
    }
}
...
pub unsafe fn rms_norm_f32(dst: &mut UbBuf, src: &UbBuf, work: &mut UbBuf, n: u32, eps: f32) {
    unsafe {
        // work = x^2
        crate::ascend_mul_f32(*work, *src, *src, n);
        crate::ascend_pipe_barrier();

        // mean_sq = sum(x^2) / n
        let sum_sq = crate::ascend_reduce_sum_f32(*work, *work, *dst, n);
        let mean_sq = sum_sq / (n as f32);
        crate::ascend_pipe_barrier();

        // inv_rms = 1 / sqrt(mean(x^2) + eps)
        let inv_rms = 1.0f32 / crate::core::builtins::sqrtf(mean_sq + eps);
        crate::ascend_muls_f32(*dst, *src, inv_rms, n);
    }
}
...
pub unsafe fn l1_norm_f32(dst: &mut UbBuf, src: &UbBuf, work: &mut UbBuf, n: u32) -> f32 {
    unsafe {
        // dst = |x|
        crate::ascend_abs_f32(*dst, *src, n);
        crate::ascend_pipe_barrier();
        // sum(|x|)
        crate::ascend_reduce_sum_f32(*dst, *dst, *work, n)
    }
}
...
pub unsafe fn l2_norm_f32(dst: &mut UbBuf, src: &UbBuf, work: &mut UbBuf, n: u32) -> f32 {
    unsafe {
        // dst = x^2
        crate::ascend_mul_f32(*dst, *src, *src, n);
        crate::ascend_pipe_barrier();
        // sum(x^2)
        let sum_sq = crate::ascend_reduce_sum_f32(*dst, *dst, *work, n);
...
pub unsafe fn l2_normalize_f32(dst: &mut UbBuf, src: &UbBuf, work: &mut UbBuf, n: u32, eps: f32) {
    unsafe {
        ...
        crate::ascend_muls_f32(*dst, *src, inv_norm, n);
    }
}
...
pub unsafe fn mse_loss_f32(
    ...
    unsafe {
        // work = pred - target
        crate::ascend_sub_f32(*work, *pred, *target, n);
        crate::ascend_pipe_barrier();
        // work = (pred - target)^2
        crate::ascend_mul_f32(*work, *work, *work, n);
        crate::ascend_pipe_barrier();
        // mean
        let sum = crate::ascend_reduce_sum_f32(*work, *work, *tmp, n);
        sum / (n as f32)
    }
}
...
pub unsafe fn huber_loss_f32(
    ...
    unsafe {
        // dst = pred - target
        crate::ascend_sub_f32(*dst, *pred, *target, n);
        crate::ascend_pipe_barrier();
        // dst = |pred - target|
        crate::ascend_abs_f32(*dst, *dst, n);
        crate::ascend_pipe_barrier();

        // tmp = min(|diff|, delta)  (clamped)
        crate::ascend_mins_f32(*tmp, *dst, delta, n);
        crate::ascend_pipe_barrier();
        // tmp = clamped^2
        crate::ascend_mul_f32(*tmp, *tmp, *tmp, n);
        crate::ascend_pipe_barrier();
        // tmp = 0.5 * clamped^2  (quadratic part)
        crate::ascend_muls_f32(*tmp, *tmp, 0.5f32, n);
        crate::ascend_pipe_barrier();

        // dst = |diff| - delta
        crate::ascend_adds_f32(*dst, *dst, -delta, n);
        crate::ascend_pipe_barrier();
        // dst = max(|diff| - delta, 0)  (excess)
        crate::ascend_maxs_f32(*dst, *dst, 0.0f32, n);
        crate::ascend_pipe_barrier();
        // dst = delta * excess  (linear part)
        crate::ascend_muls_f32(*dst, *dst, delta, n);
        crate::ascend_pipe_barrier();

        // pred = quadratic + linear = huber_element — all separate (pred != dst != tmp)
        // (pred no longer needed after initial Sub)
        crate::ascend_add_f32(*pred, *dst, *tmp, n);
        crate::ascend_pipe_barrier();

        // mean
        let sum = crate::ascend_reduce_sum_f32(*pred, *pred, *tmp, n);
        sum / (n as f32)
    }
}
...
pub unsafe fn hinge_loss_f32(
    ...
    unsafe {
        // dst = pred * target
        crate::ascend_mul_f32(*dst, *pred, *target, n);
        crate::ascend_pipe_barrier();
        // dst = -pred * target
        crate::ascend_muls_f32(*dst, *dst, -1.0f32, n);
        crate::ascend_pipe_barrier();
        ...
        crate::ascend_pipe_barrier();
        // mean
        let sum = crate::ascend_reduce_sum_f32(*dst, *dst, *tmp, n);
        sum / (n as f32)
    }
}
...
pub unsafe fn cosine_similarity_f32(
    ...
    unsafe {
        ...
        crate::ascend_mul_f32(*dst, *a, *b, n);
        crate::ascend_pipe_barrier();
        let dot = crate::ascend_reduce_sum_f32(*dst, *dst, *tmp, n);
        crate::ascend_pipe_barrier();
...
pub unsafe fn sgd_update_f32(param: &mut UbBuf, grad: &mut UbBuf, lr: f32, n: u32) {
    unsafe {
        // grad = lr * grad
        crate::ascend_muls_f32(*grad, *grad, lr, n);
        crate::ascend_pipe_barrier();
        // grad = param - lr*grad (all distinct: output=grad, src1=param, src2=grad)
        crate::ascend_sub_f32(*grad, *param, *grad, n);
        crate::ascend_pipe_barrier();
        // param = result (copy via scalar multiply by 1.0)
        crate::ascend_muls_f32(*param, *grad, 1.0f32, n);
    }
}
...
/// For larger matrices, use the low-level ascend_mmad_f16 with manual tiling.
#[inline(always)]
pub unsafe fn matmul_f16(c: *mut f32, a: *const u16, b: *const u16, m: u32, k: u32, n: u32) {
    unsafe {
        ...
        crate::ascend_matmul_cube(c, a, b, m, k, n);
    }
}
...
pub unsafe fn matmul_f16_transpose_b(
    ...
    unsafe {
        ...
        let l1_a = crate::ascend_buf_alloc_l1(m * k);
        let l1_b = crate::ascend_buf_alloc_l1(n * k); // B stored as [n,k]
        let l0a = crate::ascend_buf_alloc_l0a(m * k);
        let l0b = crate::ascend_buf_alloc_l0b(k * n);
        let l0c = crate::ascend_buf_alloc_l0c(m * n);
        let ub_c = crate::ascend_buf_alloc(m * n);

        // Stage 1: GM → L1
        crate::ascend_load_gm_to_l1_f16(l1_a, a, m * k);
        crate::ascend_load_gm_to_l1_f16(l1_b, b, n * k);
        crate::ascend_pipe_barrier();

        // Stage 2: L1 → L0A (normal), L1 → L0B (with hardware transpose)
        crate::ascend_copy_l1_to_l0a_f16(l0a, l1_a, m * k);
        crate::ascend_copy_l1_to_l0b_f16_2d(l0b, l1_b, 1, 1, 1); // transpose=1
        crate::ascend_pipe_barrier();

        // Stage 3: Mmad with transpose_b=1
        crate::ascend_mmad_f16_ex(l0c, l0a, l0b, m, k, n, 1, 0, 0, 1);
        crate::ascend_pipe_barrier();

        // Stage 4: L0C → UB → GM
        crate::ascend_copy_l0c_to_ub_f32(ub_c, l0c, m * n);
        crate::ascend_pipe_barrier();
        crate::ascend_buf_store_f32(c, ub_c, m * n);
    }
}
...
pub unsafe fn matmul_f16_transpose_a(
    ...
    unsafe {
        // Allocate cube pipeline buffers
        let l1_a = crate::ascend_buf_alloc_l1(k * m); // A stored as [k,m]
        let l1_b = crate::ascend_buf_alloc_l1(k * n);
        let l0a = crate::ascend_buf_alloc_l0a(m * k);
        let l0b = crate::ascend_buf_alloc_l0b(k * n);
        let l0c = crate::ascend_buf_alloc_l0c(m * n);
        let ub_c = crate::ascend_buf_alloc(m * n);
        ...
        // Stage 1: GM → L1
        crate::ascend_load_gm_to_l1_f16(l1_a, a, k * m);
        crate::ascend_load_gm_to_l1_f16(l1_b, b, k * n);
        crate::ascend_pipe_barrier();

        // Stage 2: L1 → L0A (with hardware transpose), L1 → L0B (normal)
        crate::ascend_copy_l1_to_l0a_f16_2d(l0a, l1_a, 1, 1, 1); // transpose=1
        crate::ascend_copy_l1_to_l0b_f16(l0b, l1_b, k * n);
        crate::ascend_pipe_barrier();

        // Stage 3: Mmad with transpose_a=1
        crate::ascend_mmad_f16_ex(l0c, l0a, l0b, m, k, n, 1, 0, 1, 0);
        crate::ascend_pipe_barrier();
...
pub unsafe fn neg_f32(dst: UbBuf, src: UbBuf, n: u32) {
    unsafe { crate::ascend_muls_f32(dst, src, -1.0f32, n); }
}

/// Negate (f16): neg(x) = -x
#[inline(always)]
pub unsafe fn neg_f16(dst: UbBuf, src: UbBuf, n: u32) {
    unsafe { crate::ascend_muls_f16(dst, src, -1.0f32, n); }
}

/// ReLU (f16): relu(x) = max(x, 0)
#[inline(always)]
pub unsafe fn relu_f16(dst: UbBuf, src: UbBuf, n: u32) {
    unsafe { crate::ascend_maxs_f16(dst, src, 0.0f32, n); }
}
...
pub unsafe fn sigmoid_f16(dst: UbBuf, src: UbBuf, n: u32) {
    unsafe {
        crate::ascend_muls_f16(dst, src, -1.0f32, n);
        crate::ascend_pipe_barrier();
        crate::ascend_exp_f16(dst, dst, n);
        crate::ascend_pipe_barrier();
        crate::ascend_adds_f16(dst, dst, 1.0f32, n);
        crate::ascend_pipe_barrier();
        crate::ascend_reciprocal_f16(dst, dst, n);
    }
}
...
pub unsafe fn tanh_f16(dst: UbBuf, src: UbBuf, n: u32) {
    unsafe {
        crate::ascend_muls_f16(dst, src, -2.0f32, n);
        crate::ascend_pipe_barrier();
        crate::ascend_exp_f16(dst, dst, n);
        crate::ascend_pipe_barrier();
        crate::ascend_adds_f16(dst, dst, 1.0f32, n);
        ...
        crate::ascend_reciprocal_f16(dst, dst, n);
        crate::ascend_pipe_barrier();
        crate::ascend_muls_f16(dst, dst, 2.0f32, n);
        crate::ascend_pipe_barrier();
        crate::ascend_adds_f16(dst, dst, -1.0f32, n);
    }
}
...
pub unsafe fn expm1_f16(dst: UbBuf, src: UbBuf, n: u32) {
    unsafe {
        crate::ascend_exp_f16(dst, src, n);
        crate::ascend_pipe_barrier();
        crate::ascend_adds_f16(dst, dst, -1.0f32, n);
    }
}
