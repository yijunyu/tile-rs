...
extern "C" {
    ...
    pub fn ascend_tile_load_f32(gm: *const f32, rows: u32, cols: u32) -> u32;
    ...
    pub fn ascend_tile_store_f32(gm: *mut f32, buf: u32, rows: u32, cols: u32);

    /// Element-wise add two f32 tiles of the same shape.
    pub fn ascend_tile_add_f32(dst: u32, src1: u32, src2: u32, rows: u32, cols: u32) -> u32;

    /// Element-wise multiply two f32 tiles of the same shape.
    pub fn ascend_tile_mul_f32(dst: u32, src1: u32, src2: u32, rows: u32, cols: u32) -> u32;

    /// Element-wise exp of an f32 tile.
    pub fn ascend_tile_exp_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;

    /// Row-wise softmax of an f32 tile (in-place reduction over columns).
    pub fn ascend_tile_softmax_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;

    /// Matrix multiply: (M × K) @ (K × N) → (M × N), all f32.
    pub fn ascend_tile_matmul_f32(dst: u32, a: u32, b: u32, m: u32, k: u32, n: u32) -> u32;

    /// Element-wise subtract two f32 tiles: a - b.
    pub fn ascend_tile_sub_f32(dst: u32, src1: u32, src2: u32, rows: u32, cols: u32) -> u32;

    /// Element-wise divide two f32 tiles: a / b.
    pub fn ascend_tile_div_f32(dst: u32, src1: u32, src2: u32, rows: u32, cols: u32) -> u32;

    /// Element-wise negate an f32 tile: -a.
    pub fn ascend_tile_neg_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;

    /// Row-wise max reduction of an f32 tile.
    /// Returns a (ROWS × 1) tile where each row is the max of that row.
    pub fn ascend_tile_reduce_max_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;

    /// Row-wise sum reduction of an f32 tile.
    pub fn ascend_tile_reduce_sum_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;

    /// Scalar multiply: scale all elements of a tile by a scalar.
    pub fn ascend_tile_scale_f32(dst: u32, src: u32, scalar: f32, rows: u32, cols: u32) -> u32;

    /// Element-wise clamp into `[lo, hi]`. Used to fence activations under
    /// MoE / DS4-style gating (cf. DS4 SwiGLU clamp_value).
    pub fn ascend_tile_clamp_f32(dst: u32, src: u32, lo: f32, hi: f32, rows: u32, cols: u32) -> u32;
    ...
    pub fn ascend_tile_attention_f32(
    ...
    pub fn ascend_tile_silu_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;

    /// RoPE: applies sin/cos rotation to (R, D) tile at position `pos`.
    pub fn ascend_tile_rope_f32(dst: u32, src: u32, pos: u32, rows: u32, cols: u32) -> u32;
    ...
    pub fn ascend_tile_rope_dsv4_f32(
    ...
    pub fn ascend_tile_dsv4_rope_tail_f32(
    ...
    pub fn ascend_tile_flash_attn_ext_f16_dk512_dv512(
    ...
    pub fn ascend_tile_flash_attn_ext_vec_f16_dk512_dv512(
    ...
    pub fn ascend_tile_dsv4_ratio4_shift_f32(state_kv: u32, state_score: u32, width: u32) -> u32;
    ...
    pub fn ascend_tile_dsv4_topk_mask_f32(
        topk: u32, dst: u32,
    ...
    pub fn ascend_tile_topk_mask_scatter_f32(topk: u32, dst: u32, num_elements: u32, dst_len: u32) -> u32;
    ...
    pub fn ascend_tile_dsv4_q8_hc_expand4_q8_0(
    ...
    pub fn ascend_tile_dsv4_shared_down_hc_expand4_q8_0(
    ...
    pub fn ascend_tile_router_weights_one_f32(probs: u32, selected: u32, weights: u32, num_experts: u32) -> u32;
    ...
    pub fn ascend_tile_indexer_weighted_sum_f32(scores: u32, weights: u32, dst: u32, num_tokens: u32, num_cols: u32, num_heads: u32) -> u32;
    ...
    pub fn ascend_tile_sort_i32_rows_asc_i32(src: u32, dst: u32, top_k: u32, num_rows: u32) -> u32;
    ...
    pub fn ascend_tile_softmax_pool_f32(kv: u32, score: u32, dst: u32, ne00: u32, ne0: u32, ne1: u32) -> u32;
    ...
    pub fn ascend_tile_compressor_store_one_f32(kv: u32, score: u32, ape: u32, state_kv: u32, state_score: u32, width: u32, ratio: u32, pos: u32) -> u32;
    ...
    pub fn ascend_tile_kv_fp8_store_f32(kv: u32, raw_cache: u32, head_dim: u32, n_rot: u32, raw_row: u32) -> u32;
    ...
    pub fn ascend_tile_fp8_kv_quantize_f32(
        src: u32, dst: u32,
        ne00: u32, ne01: u32, ne02: u32, ne03: u32,
    ...
    pub fn ascend_tile_flash_attn_ext_pad_f32(
    ...
    pub fn ascend_tile_flash_attn_ext_blk_f32(
        mask: u32, dst: u32,
    ...
    pub fn ascend_tile_indexer_score_one_direct_f32(
    ...
    pub fn ascend_tile_router_finalize_one_f32(
    ...
    pub fn ascend_tile_indexer_scores_tiled_f32(
        q: u32, weights: u32, index_comp: u32, scores: u32,
    ...
    pub fn ascend_tile_indexed_mixed_attention_h8_f32(
    ...
    pub fn ascend_tile_flash_attn_ext_vec_reduce_f32(
    ...
    pub fn ascend_tile_flash_attn_ext_vec_setup_f32(
        q: u32, k: u32, v: u32, mask: u32, sinks: u32, pad: u32, dst: u32,
    ...
    pub fn ascend_tile_flash_attn_ext_vec_score_f32(
        q: u32, k: u32, v: u32, mask: u32, sinks: u32, pad: u32, dst: u32,
    ...
    pub fn ascend_tile_flash_attn_ext_vec_out_f32(
        q: u32, k: u32, v: u32, mask: u32, sinks: u32, pad: u32, dst: u32,
    ...
    pub fn ascend_tile_flash_attn_ext_vec_out_ms_f32(
        q: u32, k: u32, v: u32, mask: u32, sinks: u32, pad: u32, dst: u32,
        dk: u32, dv: u32, ne01: u32, ne11: u32, nb01: u32, nb11: u32, nb21: u32, scale: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_flash_attn_ext_setup_f32(
        q: u32, k: u32, v: u32, mask: u32, sinks: u32, pad: u32, blk: u32, dst: u32,
        dk: u32, dv: u32, ne01: u32, nb01: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_flash_attn_ext_score_f32(
        q: u32, k: u32, v: u32, mask: u32, sinks: u32, pad: u32, blk: u32, dst: u32,
        dk: u32, dv: u32, ne01: u32, ne11: u32, nb01: u32, nb11: u32, scale: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_flash_attn_ext_out_f32(
        q: u32, k: u32, v: u32, mask: u32, sinks: u32, pad: u32, blk: u32, dst: u32,
        dk: u32, dv: u32, ne01: u32, ne11: u32, nb01: u32, nb11: u32, nb21: u32, scale: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_flash_attn_ext_out_ms_f32(
        q: u32, k: u32, v: u32, mask: u32, sinks: u32, pad: u32, blk: u32, dst: u32,
        dk: u32, dv: u32, ne01: u32, ne11: u32, nb01: u32, nb11: u32, nb21: u32, scale: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_dsv4_hc_expand_f32(
    ...
    pub fn ascend_tile_dsv4_hc_expand4_f32(
        block_out: u32, residual: u32, post: u32, comb: u32, block_add: u32, dst: u32,
        n_embd: u32, n_hc: u32, n_tokens: u32,
        nb_block0: u32, nb_block1: u32, nb_add0: u32, nb_add1: u32,
        nb_res0: u32, nb_res1: u32, nb_res2: u32,
    ...
    pub fn ascend_tile_dsv4_hc_weighted_sum_f32(
    ...
    pub fn ascend_tile_dsv4_hc_split_sinkhorn_hc4_f32(
    ...
    pub fn ascend_tile_dsv4_hc_split_weighted_sum_hc4_f32(
    ...
    pub fn ascend_tile_dsv4_hc_split_weighted_sum_norm4_f32(
        mixes: u32, scale: u32, base: u32, x: u32, split: u32, dst: u32,
    ...
    pub fn ascend_tile_argsort_f32_i32_desc(
        src: u32, dst: u32,
    ...
    pub fn ascend_tile_argsort_merge_f32_i32_desc(
    ...
    pub fn ascend_tile_argsort_f32_i32_desc_full(
        src0: u32, dst: u32,
        ne00: u32, ne01: u32, ne02: u32, ne03: u32,
        nb00: u32, nb01: u32, nb02: u32, nb03: u32,
    ...
    /// total = len0+len1.
    pub fn ascend_tile_argsort_merge_f32_i32_desc_full(
    ...
    /// weights (const).
    pub fn ascend_tile_moe_swiglu_weight_f32(
    ...
    pub fn ascend_tile_moe_swiglu_weight_f16(
        gate: u32, up: u32, mid: u32, weights: u32,
        width: u32, rows: u32,
        gate_row_stride: u32, up_row_stride: u32, mid_row_stride: u32,
        weight_stride: u32, write_clamped: u32, clamp_value: u32,
    ...
    pub fn ascend_tile_mul_mm_id_map0_f32(
    ...
    pub fn ascend_tile_mul_mm_id_map0_ne20_8_full(
        src2: u32, htpe: u32, hids: u32,
    ...
    pub fn ascend_tile_mul_mm_id_map0_ne20_4_full(
        src2: u32, htpe: u32, hids: u32,
        ne02: u32, ne10: u32, ne11: u32, nb11: u32, nb12: u32,
        ne21: u32, ne20: u32, nb21: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_mul_mm_id_map0_ne20_1_full(
        src2: u32, htpe: u32, hids: u32,
        ne02: u32, ne10: u32, ne11: u32, nb11: u32, nb12: u32,
        ne21: u32, ne20: u32, nb21: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_mul_mm_id_map0_ne20_2_full(
        src2: u32, htpe: u32, hids: u32,
        ne02: u32, ne10: u32, ne11: u32, nb11: u32, nb12: u32,
        ne21: u32, ne20: u32, nb21: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_mul_mm_id_map0_ne20_5_full(
        src2: u32, htpe: u32, hids: u32,
        ne02: u32, ne10: u32, ne11: u32, nb11: u32, nb12: u32,
        ne21: u32, ne20: u32, nb21: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_mul_mm_id_map0_ne20_6_full(
        src2: u32, htpe: u32, hids: u32,
        ne02: u32, ne10: u32, ne11: u32, nb11: u32, nb12: u32,
        ne21: u32, ne20: u32, nb21: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_mul_mm_id_map0_ne20_10_full(
        src2: u32, htpe: u32, hids: u32,
        ne02: u32, ne10: u32, ne11: u32, nb11: u32, nb12: u32,
        ne21: u32, ne20: u32, nb21: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_mul_mm_id_map0_ne20_16_full(
        src2: u32, htpe: u32, hids: u32,
        ne02: u32, ne10: u32, ne11: u32, nb11: u32, nb12: u32,
        ne21: u32, ne20: u32, nb21: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_mul_mm_id_map0_ne20_22_full(
        src2: u32, htpe: u32, hids: u32,
        ne02: u32, ne10: u32, ne11: u32, nb11: u32, nb12: u32,
        ne21: u32, ne20: u32, nb21: u32,
    ) -> u32;
    ...
    /// kv_dst (writable).
    pub fn ascend_tile_qkv_rms_norm_f32_4(
    ...
    pub fn ascend_tile_rms_norm_mul_f32_4(
    ...
    /// `ascend_tile_rms_norm_mul_f32_4` minus the weight buffer.
    pub fn ascend_tile_rms_norm_f32_4(
        src: u32, dst: u32,
        n: u32, n4: u32, row_stride: u32, eps: u32,
    ) -> u32;
    ...
    /// stride bytes), scale.
    pub fn ascend_tile_softmax_f32_4_strided(
        src: u32, dst: u32,
    ...
    pub fn ascend_tile_softmax_f32_4_mask_f16(
    ...
    pub fn ascend_tile_softmax_f32_4_mask_f32(
        src: u32, mask: u32, dst: u32,
        ne00: u32, nb01: u32, nb_mask: u32, nb1: u32, scale: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_softmax_f32_scalar_strided(
        src: u32, dst: u32,
        ne00: u32, nb01: u32, nb1: u32, scale: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_softmax_f32_scalar_mask_f16(
        src: u32, mask: u32, dst: u32,
        ne00: u32, nb01: u32, nb_mask: u32, nb1: u32, scale: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_softmax_f32_scalar_mask_f32(
        src: u32, mask: u32, dst: u32,
        ne00: u32, nb01: u32, nb_mask: u32, nb1: u32, scale: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_softmax_f32_4_sink(
    ...
    pub fn ascend_tile_softmax_f32_scalar_sink(
        src: u32, sink: u32, dst: u32,
        ne00: u32, nb01: u32, nb1: u32, scale: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_softmax_f32_4_mask_f16_sink(
    ...
    pub fn ascend_tile_softmax_f32_4_mask_f32_sink(
        src: u32, mask: u32, sink: u32, dst: u32,
        ne00: u32, nb01: u32, nb_mask: u32, nb1: u32, scale: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_softmax_f32_scalar_mask_f16_sink(
        src: u32, mask: u32, sink: u32, dst: u32,
        ne00: u32, nb01: u32, nb_mask: u32, nb1: u32, scale: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_softmax_f32_scalar_mask_f32_sink(
        src: u32, mask: u32, sink: u32, dst: u32,
        ne00: u32, nb01: u32, nb_mask: u32, nb1: u32, scale: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_softmax_f32_4_alibi_f16_sink(
        src: u32, mask: u32, sink: u32, dst: u32,
        ne00: u32, nb01: u32, nb_mask: u32, nb1: u32, scale: u32, slope: u32,
    ) -> u32;

    /// DS4 kernel_soft_max_f32_4 ALiBi + sink (f32 mask).
    pub fn ascend_tile_softmax_f32_4_alibi_f32_sink(
        src: u32, mask: u32, sink: u32, dst: u32,
        ne00: u32, nb01: u32, nb_mask: u32, nb1: u32, scale: u32, slope: u32,
    ) -> u32;

    /// DS4 kernel_soft_max<float> ALiBi mask path (f16 mask, no sink, scalar lanewise).
    /// Scalar sibling of `ascend_tile_softmax_f32_4_alibi_f16`.
    pub fn ascend_tile_softmax_f32_scalar_alibi_f16(
        src: u32, mask: u32, dst: u32,
        ne00: u32, nb01: u32, nb_mask: u32, nb1: u32, scale: u32, slope: u32,
    ) -> u32;

    /// DS4 kernel_soft_max<float> ALiBi mask path (f32 mask, no sink, scalar lanewise).
    pub fn ascend_tile_softmax_f32_scalar_alibi_f32(
        src: u32, mask: u32, dst: u32,
        ne00: u32, nb01: u32, nb_mask: u32, nb1: u32, scale: u32, slope: u32,
    ) -> u32;

    /// DS4 kernel_soft_max<float> ALiBi + sink (f16 mask, scalar lanewise).
    pub fn ascend_tile_softmax_f32_scalar_alibi_f16_sink(
        src: u32, mask: u32, sink: u32, dst: u32,
        ne00: u32, nb01: u32, nb_mask: u32, nb1: u32, scale: u32, slope: u32,
    ) -> u32;

    /// DS4 kernel_soft_max<float> ALiBi + sink (f32 mask, scalar lanewise).
    pub fn ascend_tile_softmax_f32_scalar_alibi_f32_sink(
        src: u32, mask: u32, sink: u32, dst: u32,
        ne00: u32, nb01: u32, nb_mask: u32, nb1: u32, scale: u32, slope: u32,
    ) -> u32;
    ...
    /// suffix avoids shadowing the legacy `ascend_tile_sum_rows_f32`
    /// (cpp-tile / no-batch variant) which is still mapped to the
    /// classic `KernelType::SumRows` emitter.
    pub fn ascend_tile_sum_rows_f32_strided(
        src: u32, dst: u32,
    ...
    /// avoids shadowing the legacy `ascend_tile_cpy_f32` mapping.
    pub fn ascend_tile_cpy_f32_f32_strided(
        src: u32, dst: u32,
        ne00: u32, ne01: u32, ne02: u32, ne03: u32,
        nb00: u32, nb01: u32, nb02: u32, nb03: u32,
        ne0:  u32, ne1:  u32, ne2:  u32, ne3:  u32,
    ...
    /// `ascend_tile_cpy_f32_f32_strided`. Same dims/strides.
    pub fn ascend_tile_cpy_f32_f16_strided(
        src: u32, dst: u32,
        ne00: u32, ne01: u32, ne02: u32, ne03: u32,
        nb00: u32, nb01: u32, nb02: u32, nb03: u32,
        ne0:  u32, ne1:  u32, ne2:  u32, ne3:  u32,
    ...
    /// `ascend_tile_cpy_f32_f32_strided`. Same dims/strides.
    pub fn ascend_tile_cpy_f16_f32_strided(
        src: u32, dst: u32,
        ne00: u32, ne01: u32, ne02: u32, ne03: u32,
        nb00: u32, nb01: u32, nb02: u32, nb03: u32,
        ne0:  u32, ne1:  u32, ne2:  u32, ne3:  u32,
    ...
    /// each axis. Same 16-uint stride/dim block as `ascend_tile_cpy_*_strided`.
    pub fn ascend_tile_repeat_f32_strided(
        src: u32, dst: u32,
        ne00: u32, ne01: u32, ne02: u32, ne03: u32,
        nb00: u32, nb01: u32, nb02: u32, nb03: u32,
        ne0:  u32, ne1:  u32, ne2:  u32, ne3:  u32,
    ...
    pub fn ascend_tile_concat_f32_strided(
    ...
    pub fn ascend_tile_get_rows_f32_strided(
        src0: u32, src1: u32, dst: u32,
        ne00t: u32, ne00: u32,
    ...
    /// sibling of `ascend_tile_get_rows_f32_strided`. Same param block.
    pub fn ascend_tile_get_rows_f16_strided(
        src0: u32, src1: u32, dst: u32,
        ne00t: u32, ne00: u32,
        nb01: u32, nb02: u32, nb03: u32,
        ne10: u32,
    ...
    /// sibling of `ascend_tile_get_rows_f32_strided`. Same param block.
    pub fn ascend_tile_get_rows_i32_strided(
        src0: u32, src1: u32, dst: u32,
        ne00t: u32, ne00: u32,
        nb01: u32, nb02: u32, nb03: u32,
        ne10: u32,
    ...
    pub fn ascend_tile_set_rows_f32_i32_strided(
        src0: u32, src1: u32, dst: u32,
        nk0: u32, ne01: u32,
        nb01: u32, nb02: u32, nb03: u32,
        ne11: u32, ne12: u32,
    ...
    pub fn ascend_tile_dsv4_softplus_sqrt_f32_4(
        src: u32, dst: u32,
        ne0_4: u32, nb_src: u32, nb_dst: u32,
    ) -> u32;

    /// DS4 kernel_unary_f32_f32_4 (SIGMOID op): per-row float4 lanewise sigmoid.
    /// Same dispatch as `ascend_tile_dsv4_softplus_sqrt_f32_4`.
    pub fn ascend_tile_sigmoid_f32_4(
        src: u32, dst: u32,
        ne0_4: u32, nb_src: u32, nb_dst: u32,
    ) -> u32;

    /// DS4 kernel_unary_f32_f32_4 (RELU op): per-row float4 lanewise fmax(0, x).
    /// Same dispatch/params as `ascend_tile_sigmoid_f32_4`.
    pub fn ascend_tile_relu_f32_4(
        src: u32, dst: u32,
        ne0_4: u32, nb_src: u32, nb_dst: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_hardsigmoid_f32_4(
        src: u32, dst: u32,
        ne0_4: u32, nb_src: u32, nb_dst: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_hardswish_f32_4(
        src: u32, dst: u32,
        ne0_4: u32, nb_src: u32, nb_dst: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_sigmoid_f32_scalar(
        src: u32, dst: u32,
        ne0: u32, nb_src: u32, nb_dst: u32,
    ) -> u32;

    /// DS4 kernel_unary_f32_f32 (relu op): per-row scalar float fmax(0, x).
    pub fn ascend_tile_relu_f32_scalar(src: u32, dst: u32, ne0: u32, nb_src: u32, nb_dst: u32) -> u32;
    /// DS4 kernel_unary_f32_f32 (tanh op): per-row scalar float precise::tanh(x).
    pub fn ascend_tile_tanh_f32_scalar(src: u32, dst: u32, ne0: u32, nb_src: u32, nb_dst: u32) -> u32;
    /// DS4 kernel_unary_f32_f32 (gelu op): per-row scalar float tanh-approx GELU.
    pub fn ascend_tile_gelu_f32_scalar(src: u32, dst: u32, ne0: u32, nb_src: u32, nb_dst: u32) -> u32;
    /// DS4 kernel_unary_f32_f32 (silu op): per-row scalar float x/(1+exp(-x)).
    pub fn ascend_tile_silu_f32_scalar(src: u32, dst: u32, ne0: u32, nb_src: u32, nb_dst: u32) -> u32;
    /// DS4 kernel_unary_f32_f32 (hardsigmoid op): per-row scalar float fmax(0,fmin(1,x/6+0.5)).
    pub fn ascend_tile_hardsigmoid_f32_scalar(src: u32, dst: u32, ne0: u32, nb_src: u32, nb_dst: u32) -> u32;
    /// DS4 kernel_unary_f32_f32 (hardswish op): per-row scalar float x*hardsigmoid(x).
    pub fn ascend_tile_hardswish_f32_scalar(src: u32, dst: u32, ne0: u32, nb_src: u32, nb_dst: u32) -> u32;
    /// DS4 kernel_unary_f32_f32 (sqr op): per-row scalar float x*x.
    pub fn ascend_tile_sqr_f32_scalar(src: u32, dst: u32, ne0: u32, nb_src: u32, nb_dst: u32) -> u32;
    /// DS4 kernel_unary_f32_f32 (neg op): per-row scalar float -x.
    pub fn ascend_tile_neg_f32_scalar(src: u32, dst: u32, ne0: u32, nb_src: u32, nb_dst: u32) -> u32;
    /// DS4 kernel_unary_f32_f32 (abs op): per-row scalar float fabs(x).
    pub fn ascend_tile_abs_f32_scalar(src: u32, dst: u32, ne0: u32, nb_src: u32, nb_dst: u32) -> u32;
    /// DS4 kernel_unary_f32_f32 (step op): per-row scalar float x>0?1:0.
    pub fn ascend_tile_step_f32_scalar(src: u32, dst: u32, ne0: u32, nb_src: u32, nb_dst: u32) -> u32;
    /// DS4 kernel_unary_f32_f32 (exp op): per-row scalar float exp(x).
    pub fn ascend_tile_exp_f32_scalar(src: u32, dst: u32, ne0: u32, nb_src: u32, nb_dst: u32) -> u32;
    /// DS4 kernel_unary_f32_f32 (log op): per-row scalar float log(x).
    pub fn ascend_tile_log_f32_scalar(src: u32, dst: u32, ne0: u32, nb_src: u32, nb_dst: u32) -> u32;
    ...
    pub fn ascend_tile_mul_mv_f32_f32_short(
        src0: u32, src1: u32, dst: u32,
    ...
    pub fn ascend_tile_mul_mv_f16_f32_short(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne01: u32, ne0: u32, ne1: u32,
        ne12: u32, r2: u32, r3: u32,
        nb01: u32, nb02: u32, nb03: u32,
    ...
    pub fn ascend_tile_mul_mv_f32_f32_setup(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne01: u32, ne0: u32, ne1: u32,
        ne12: u32, r2: u32, r3: u32,
        nb01: u32, nb02: u32, nb03: u32,
    ...
    pub fn ascend_tile_mul_mv_f32_f32_acc(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne01: u32, ne0: u32, ne1: u32,
        ne12: u32, r2: u32, r3: u32,
        nb01: u32, nb02: u32, nb03: u32,
    ...
    pub fn ascend_tile_mul_mv_f32_f32_reduce(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne01: u32, ne0: u32, ne1: u32,
        ne12: u32, r2: u32, r3: u32,
        nb01: u32, nb02: u32, nb03: u32,
    ...
    /// ascend_tile_mul_mv_f32_f32_reduce; same body with src0 read as half
    /// then cast to float in the K-accumulator.
    pub fn ascend_tile_mul_mv_f16_f32_reduce(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne01: u32, ne0: u32, ne1: u32,
        ne12: u32, r2: u32, r3: u32,
        nb01: u32, nb02: u32, nb03: u32,
    ...
    pub fn ascend_tile_mul_mv_f32_f32_4_reduce(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne01: u32, ne0: u32, ne1: u32,
        ne12: u32, r2: u32, r3: u32,
        nb01: u32, nb02: u32, nb03: u32,
    ...
    /// sibling of ascend_tile_mul_mv_f32_f32_4_reduce.
    pub fn ascend_tile_mul_mv_f16_f32_4_reduce(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne01: u32, ne0: u32, ne1: u32,
        ne12: u32, r2: u32, r3: u32,
        nb01: u32, nb02: u32, nb03: u32,
    ...
    pub fn ascend_tile_mul_mv_f16_f32_pair_4(
    ...
    pub fn ascend_tile_mul_mv_q8_0_f32(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne01: u32, ne0: u32, ne1: u32,
        ne12: u32, r2: u32, r3: u32,
        nb01: u32, nb02: u32, nb03: u32,
    ...
    pub fn ascend_tile_mul_mv_id_q8_0_f32(
    ...
    pub fn ascend_tile_mul_mv_id_q2_K_f32(
        src0s: u32, src1: u32, ids: u32, dst: u32,
        ne00: u32, ne01: u32, ne0: u32, ne1: u32, ne11: u32,
        nei0: u32, nbi1: u32,
        nb01: u32, nb02: u32, nb11: u32, nb12: u32,
    ...
    pub fn ascend_tile_mul_mv_id_q4_K_f32(
        src0s: u32, src1: u32, ids: u32, dst: u32,
        ne00: u32, ne01: u32, ne0: u32, ne1: u32, ne11: u32,
        nei0: u32, nbi1: u32,
        nb01: u32, nb02: u32, nb11: u32, nb12: u32,
    ...
    pub fn ascend_tile_mul_mv_id_iq2_xxs_f32(
        src0s: u32, src1: u32, ids: u32, dst: u32,
        ne00: u32, ne01: u32, ne0: u32, ne1: u32, ne11: u32,
        nei0: u32, nbi1: u32,
        nb01: u32, nb02: u32, nb11: u32, nb12: u32,
    ...
    pub fn ascend_tile_mul_mv_id_iq2_xxs_pair_f32(
    ...
    pub fn ascend_tile_mul_mv_id_iq2_xxs_pair_swiglu_f32(
    ...
    pub fn ascend_tile_mul_mv_id_q4_K_pair_f32(
        src0_gate: u32, src0_up: u32, src1: u32, dst_gate: u32, dst_up: u32, ids: u32,
        ne00: u32, ne01: u32, ne0: u32, ne1: u32, ne11: u32,
        nei0: u32, nbi1: u32,
        nb01: u32, nb02: u32, nb11: u32, nb12: u32,
    ...
    /// produces gate, up, AND mid = silu(clamp(gate,c)) * clamp(up,-c,c) *
    /// route_weight where route_weight = weights[idx*weight_stride/4][0].
    pub fn ascend_tile_mul_mv_id_q4_K_pair_swiglu_f32(
        src0_gate: u32, src0_up: u32, src1: u32, dst_gate: u32, dst_up: u32, dst_mid: u32, ids: u32, weights: u32,
        ne00: u32, ne01: u32, ne0: u32, ne1: u32, ne11: u32,
        nei0: u32, nbi1: u32,
        nb01: u32, nb02: u32, nb11: u32, nb12: u32,
    ...
    pub fn ascend_tile_mul_mv_id_q2_K_sum6_f32(
    ...
    pub fn ascend_tile_mul_mv_id_q4_K_sum6_f32(
        src0s: u32, src1: u32, dst: u32, ids: u32,
        ne00: u32, ne0: u32, nbi1: u32,
        nb01: u32, nb02: u32, nb11: u32, nb12: u32, nb1: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_dsv4_attn_out_low_q8_0_f32(
    ...
    pub fn ascend_tile_dsv4_shared_gate_up_swiglu_q8_0(
    ...
    /// NSG=4, NW=32.
    pub fn ascend_tile_mul_mv_f32_f32(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne01: u32, ne0: u32, ne1: u32, ne12: u32,
    ...
    pub fn ascend_tile_mul_mv_f16_f32(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne01: u32, ne0: u32, ne1: u32, ne12: u32,
        r2: u32, r3: u32, nr0: u32,
        nb01: u32, nb02: u32, nb03: u32,
    ...
    pub fn ascend_tile_mul_mv_f32_f32_4(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne01: u32, ne0: u32, ne1: u32, ne12: u32,
        r2: u32, r3: u32, nr0: u32,
        nb01: u32, nb02: u32, nb03: u32,
    ...
    pub fn ascend_tile_mul_mv_f16_f32_4(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne01: u32, ne0: u32, ne1: u32, ne12: u32,
        r2: u32, r3: u32, nr0: u32,
        nb01: u32, nb02: u32, nb03: u32,
    ...
    pub fn ascend_tile_soft_max_f32(
        src0: u32, src1: u32, src2: u32, dst: u32,
    ...
    pub fn ascend_tile_soft_max_f32_4(
        src0: u32, src1: u32, src2: u32, dst: u32,
        ne00: u32, ne01: u32, ne02: u32,
        nb01: u32, nb02: u32, nb03: u32,
        ne11: u32, ne12: u32, ne13: u32,
    ...
    pub fn ascend_tile_bin_fuse_f32(
        src0: u32, src1: u32, dst: u32,
    ...
    pub fn ascend_tile_unary_f32_4(
        src0: u32, dst: u32,
        ne01: u32,
        nb01: u32, nb02: u32, nb03: u32,
        ne0: u32, nb1: u32, nb2: u32, nb3: u32,
    ...
    pub fn ascend_tile_mul_mv_ext_f16_f32_r1_2(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne01: u32, ne02: u32,
        nb01: u32, nb02: u32, nb03: u32,
    ...
    pub fn ascend_tile_mul_mv_ext_f16_f32_r1_3(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne01: u32, ne02: u32,
        nb01: u32, nb02: u32, nb03: u32,
        ne10: u32, ne11: u32, ne12: u32,
    ...
    pub fn ascend_tile_mul_mv_ext_f16_f32_r1_4(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne01: u32, ne02: u32,
        nb01: u32, nb02: u32, nb03: u32,
        ne10: u32, ne11: u32, ne12: u32,
    ...
    pub fn ascend_tile_mul_mv_ext_f16_f32_r1_5(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne01: u32, ne02: u32,
        nb01: u32, nb02: u32, nb03: u32,
        ne10: u32, ne11: u32, ne12: u32,
    ...
    pub fn ascend_tile_mul_mv_ext_q8_0_f32_r1_2(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne01: u32, ne02: u32,
        nb01: u32, nb02: u32, nb03: u32,
        ne10: u32, ne11: u32, ne12: u32,
    ...
    pub fn ascend_tile_mul_mv_ext_q8_0_f32_r1_3(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne01: u32, ne02: u32,
        nb01: u32, nb02: u32, nb03: u32,
        ne10: u32, ne11: u32, ne12: u32,
    ...
    pub fn ascend_tile_mul_mv_ext_q8_0_f32_r1_4(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne01: u32, ne02: u32,
        nb01: u32, nb02: u32, nb03: u32,
        ne10: u32, ne11: u32, ne12: u32,
    ...
    pub fn ascend_tile_mul_mv_ext_q8_0_f32_r1_5(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne01: u32, ne02: u32,
        nb01: u32, nb02: u32, nb03: u32,
        ne10: u32, ne11: u32, ne12: u32,
    ...
    pub fn ascend_tile_mul_mm_f16_f32(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne02: u32,
        nb01: u32, nb02: u32, nb03: u32,
        ne12: u32,
    ...
    pub fn ascend_tile_mul_mm_id_q8_0_f32(
    ...
    pub fn ascend_tile_mul_mm_id_q8_0_f16(
        src0: u32, src1: u32, htpe: u32, hids: u32, dst: u32,
        ne00: u32, ne02: u32,
        nb01: u32, nb02: u32, nb03: u32,
        nb10: u32, nb11: u32, nb12: u32, nb13: u32,
    ...
    pub fn ascend_tile_mul_mm_id_q2_K_f32(
        src0: u32, src1: u32, htpe: u32, hids: u32, dst: u32,
        ne00: u32, ne02: u32,
        nb01: u32, nb02: u32, nb03: u32,
        nb10: u32, nb11: u32, nb12: u32, nb13: u32,
    ...
    pub fn ascend_tile_mul_mm_id_q2_K_f16(
        src0: u32, src1: u32, htpe: u32, hids: u32, dst: u32,
        ne00: u32, ne02: u32,
        nb01: u32, nb02: u32, nb03: u32,
        nb10: u32, nb11: u32, nb12: u32, nb13: u32,
    ...
    pub fn ascend_tile_mul_mm_id_q4_K_f32(
        src0: u32, src1: u32, htpe: u32, hids: u32, dst: u32,
        ne00: u32, ne02: u32,
        nb01: u32, nb02: u32, nb03: u32,
        nb10: u32, nb11: u32, nb12: u32, nb13: u32,
    ...
    /// accumulator output to half on store.
    pub fn ascend_tile_mul_mm_id_q4_K_f16(
        src0: u32, src1: u32, htpe: u32, hids: u32, dst: u32,
        ne00: u32, ne02: u32,
        nb01: u32, nb02: u32, nb03: u32,
        nb10: u32, nb11: u32, nb12: u32, nb13: u32,
    ...
    pub fn ascend_tile_mul_mm_id_iq2_xxs_f32(
        src0: u32, src1: u32, htpe: u32, hids: u32, dst: u32,
        ne00: u32, ne02: u32,
        nb01: u32, nb02: u32, nb03: u32,
        nb10: u32, nb11: u32, nb12: u32, nb13: u32,
    ...
    pub fn ascend_tile_mul_mm_id_iq2_xxs_f16(
        src0: u32, src1: u32, htpe: u32, hids: u32, dst: u32,
        ne00: u32, ne02: u32,
        nb01: u32, nb02: u32, nb03: u32,
        nb10: u32, nb11: u32, nb12: u32, nb13: u32,
    ...
    ///          src1 (half [ne00 x ne1 x ne12 x ne13]),
    ///          dst  (float[ne0 x ne1 x ne12 x ne13]).
    /// Same 14-uint param shape as ascend_tile_mul_mm_f16_f32.
    pub fn ascend_tile_mul_mm_q8_0_f32(
        src0: u32, src1: u32, dst: u32,
        ne00: u32, ne02: u32,
        nb01: u32, nb02: u32, nb03: u32,
        ne12: u32,
    ...
    pub fn ascend_tile_indexed_mixed_attention_h8_rb4_f32(
        q: u32, raw_kv: u32, comp_kv: u32, topk: u32, sinks: u32, dst: u32,
        n_tokens: u32, n_head: u32, n_raw: u32, n_comp: u32, top_k: u32, ratio: u32,
        window: u32, pos0: u32, raw_start: u32, raw_cap: u32,
        q_token_stride: u32, q_head_stride: u32, raw_row_stride: u32,
    ...
    pub fn ascend_tile_indexer_scores_tiled_bf16(
        q: u32, weights: u32, index_comp: u32, scores: u32,
        n_comp: u32, n_tokens: u32, n_head: u32, pos0: u32, ratio: u32,
        q_token_stride: u32, q_head_stride: u32, weights_token_stride: u32,
        index_row_stride: u32, score_token_stride: u32, scale: u32,
    ...
    pub fn ascend_tile_causal_mask_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;

    /// Embedding lookup: gathers `count` rows from (V, D) weight table by index.
    pub fn ascend_tile_embedding_f32(
    ...
    pub fn ascend_tile_cross_entropy_f32(
    ...
    pub fn ascend_tile_transpose_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;

    /// Element-wise 1/sqrt(x).
    pub fn ascend_tile_rsqrt_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;

    /// Element-wise natural logarithm.
    pub fn ascend_tile_log_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;

    /// Element-wise sigmoid: 1/(1+exp(-x)).
    pub fn ascend_tile_sigmoid_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;

    /// Cast f32 tile to f16 tile.
    pub fn ascend_tile_cast_f32_f16(dst: u32, src: u32, rows: u32, cols: u32) -> u32;

    /// Cast f16 tile to f32 tile.
    pub fn ascend_tile_cast_f16_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;

    /// Extract sub-tile: (R2 × C2) from (R × C) at offset (row_off, col_off).
    pub fn ascend_tile_slice_f32(
        dst: u32, src: u32,
    ...
    /// for the topk_selector port (composes with `ascend_tile_sort32_f32`).
    /// Lowers to `pto.tci` on Ascend.
    pub fn ascend_tile_arith_progression_i32(
    ...
    /// for safe consumption by `ascend_tile_sort32_f32`.
    /// Lowers to `pto.tfillpad` on Ascend.
    pub fn ascend_tile_init_sort_buf_f32(
    ...
    pub fn ascend_tile_mrgsort2_f32(
    ...
    /// for M=1 decode).
    pub fn ascend_tile_matmul_i8_acc_i32_dequant_f16(
    ...
    pub fn ascend_tile_load_i8(gm: *const i8, rows: u32, cols: u32) -> u32;

    /// Store an i8 tile buffer to global memory.
    pub fn ascend_tile_store_i8(gm: *mut i8, buf: u32, rows: u32, cols: u32);
    ...
    pub fn ascend_tile_matmul_transposed_f32(
        dst: u32, a: u32, b: u32,
        m: u32, k: u32, n: u32,
    ) -> u32;

    /// f16 variant of matmul_transposed.
    pub fn ascend_tile_matmul_transposed_f16(
        dst: u32, a: u32, b: u32,
        m: u32, k: u32, n: u32,
    ) -> u32;
    ...
    pub fn ascend_tile_fill_f32(dst: u32, scalar: f32, rows: u32, cols: u32) -> u32;

    /// Element-wise max of two tiles.
    pub fn ascend_tile_max_f32(dst: u32, a: u32, b: u32, rows: u32, cols: u32) -> u32;

    /// Element-wise min of two tiles.
    pub fn ascend_tile_min_f32(dst: u32, a: u32, b: u32, rows: u32, cols: u32) -> u32;

    /// Hyperbolic tangent.
    pub fn ascend_tile_tanh_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;

    /// Element-wise absolute value.
    pub fn ascend_tile_abs_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;

    /// Element-wise square root.
    pub fn ascend_tile_sqrt_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;

    /// Element-wise ReLU: max(x, 0).
    pub fn ascend_tile_relu_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;

    /// Element-wise Softplus: log(1 + exp(x)).
    pub fn ascend_tile_softplus_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;

    // ascend_tile_sub_f32, ascend_tile_reduce_max_f32, ascend_tile_div_f32
    // are declared earlier in this same extern block.

    /// RMS normalization: x * rsqrt(mean(x^2) + eps).
    pub fn ascend_tile_rms_norm_f32(dst: u32, src: u32, eps: f32, rows: u32, cols: u32) -> u32;

    // ── Phase 4: Quantization primitives ────────────────────────────

    /// Symmetric INT8 quantize: round(x / scale), clamped to [-128, 127].
    pub fn ascend_tile_quantize_f32_i8(dst: u32, src: u32, scale: f32, rows: u32, cols: u32) -> u32;

    /// INT8 dequantize: x_i8 * scale → f32.
    pub fn ascend_tile_dequantize_i8_f32(dst: u32, src: u32, scale: f32, rows: u32, cols: u32) -> u32;

    /// Row-wise absmax: max(|x|) per row → (R, 1).
    pub fn ascend_tile_absmax_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;
    ...
    pub fn ascend_tile_argmax_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;
    ...
    pub fn ascend_tile_sample_top_p_f32(dst: u32, logits: u32, temperature: f32, top_p: f32, rng_seed: u32, rows: u32, cols: u32) -> u32;
    ...
    pub fn ascend_tile_draft_verify_f32(dst: u32, draft_tokens: u32, target_logits: u32, rows: u32, cols: u32) -> u32;
    ...
    pub fn ascend_tile_token_accept_f32(dst: u32, draft_tokens: u32, target_tokens: u32, accept_probs: u32, threshold: f32, rows: u32) -> u32;
    ...
    pub fn ascend_tile_matvec_f16(dst: u32, a: u32, b: u32, rows: u32, cols: u32) -> u32;
    ...
    pub fn ascend_tile_matvec_f32(dst: u32, a: u32, b: u32, rows: u32, cols: u32) -> u32;

    /// Cooperative matvec with f16 weights and bias addition.
    pub fn ascend_tile_matvec_f16_bias(dst: u32, a: u32, b: u32, bias: u32, rows: u32, cols: u32) -> u32;

    /// In-place RoPE for decode: applies rotary embedding to a single token.
    /// x is (num_heads × head_dim), modified in-place.
    pub fn ascend_tile_rope_inplace_f32(dst: u32, x: u32, rows: u32, cols: u32) -> u32;

    /// KV cache update: copy vector (num_heads × head_dim) into cache at position.
    /// Cache layout: (num_heads, max_seq, head_dim).
    pub fn ascend_tile_kv_cache_update_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;
    ...
    pub fn ascend_tile_attention_decode_f32(dst: u32, q: u32, k: u32, v: u32, rows: u32, cols: u32) -> u32;
    ...
    pub fn ascend_tile_rope_prefill_f32(dst: u32, x: u32, rows: u32, cols: u32) -> u32;

    /// Batched KV cache update for prefill: copies seq_len vectors into cache.
    pub fn ascend_tile_kv_cache_update_prefill_f32(dst: u32, src: u32, rows: u32, cols: u32) -> u32;
    ...
    pub fn ascend_tile_attention_prefill_f32(dst: u32, q: u32, k: u32, v: u32, rows: u32, cols: u32) -> u32;

    // --- Fused decode intrinsics ---

    /// Cooperative matvec + residual add: out = A @ B^T + R.
    pub fn ascend_tile_matvec_f16_add(dst: u32, a: u32, b: u32, r: u32, rows: u32, cols: u32) -> u32;

    /// Fused gate+up+silu: reads activation once, computes silu(A@W_gate) * (A@W_up).
    pub fn ascend_tile_gate_up_silu_f16(dst: u32, a: u32, w_gate: u32, w_up: u32, rows: u32, cols: u32) -> u32;
}
...
extern "C" {
    ...
    pub fn ascend_tile_load_f16(gm: *const u16, rows: u32, cols: u32) -> u32;

    /// Store a local f16 tile buffer to global memory (as u16).
    pub fn ascend_tile_store_f16(gm: *mut u16, buf: u32, rows: u32, cols: u32);

    /// Element-wise add two f16 tiles.
    pub fn ascend_tile_add_f16(dst: u32, src1: u32, src2: u32, rows: u32, cols: u32) -> u32;

    /// Element-wise multiply two f16 tiles.
    pub fn ascend_tile_mul_f16(dst: u32, src1: u32, src2: u32, rows: u32, cols: u32) -> u32;

    /// Row-wise softmax of an f16 tile.
    pub fn ascend_tile_softmax_f16(dst: u32, src: u32, rows: u32, cols: u32) -> u32;
}
...
extern "C" {
    #[doc(hidden)]
    pub fn ascend_tile_pipelined_for_begin(depth: u32);
    #[doc(hidden)]
    pub fn ascend_tile_pipelined_for_end();
}
...
pub fn pipelined_for(depth: u32) {
    unsafe { ascend_tile_pipelined_for_begin(depth) }
}
...
pub fn tile_load_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_load_f32(gm, ROWS as u32, COLS as u32) };
    Tile {
        buf_id,
...
pub fn tile_store_f32<const ROWS: usize, const COLS: usize>(
    ...
    unsafe { ascend_tile_store_f32(gm, tile.buf_id, ROWS as u32, COLS as u32) };
}
...
pub fn tile_add_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_add_f32(0, a.buf_id, b.buf_id, ROWS as u32, COLS as u32) };
    Tile {
        buf_id,
        _phantom: PhantomData,
    }
...
pub fn tile_mul_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_mul_f32(0, a.buf_id, b.buf_id, ROWS as u32, COLS as u32) };
    Tile {
        buf_id,
        _phantom: PhantomData,
    }
...
pub fn tile_exp_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_exp_f32(0, src.buf_id, ROWS as u32, COLS as u32) };
    Tile {
        buf_id,
        _phantom: PhantomData,
    }
...
pub fn tile_softmax_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_softmax_f32(0, src.buf_id, ROWS as u32, COLS as u32) };
    Tile {
        buf_id,
        _phantom: PhantomData,
    }
...
pub fn tile_matmul_f32<const M: usize, const K: usize, const N: usize>(
    ...
    let buf_id =
        unsafe { ascend_tile_matmul_f32(0, a.buf_id, b.buf_id, M as u32, K as u32, N as u32) };
    Tile {
        buf_id,
        _phantom: PhantomData,
    }
...
pub fn tile_sub_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_sub_f32(0, a.buf_id, b.buf_id, ROWS as u32, COLS as u32) };
...
pub fn tile_div_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_div_f32(0, a.buf_id, b.buf_id, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_neg_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_neg_f32(0, src.buf_id, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_reduce_max_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_reduce_max_f32(0, src.buf_id, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_reduce_sum_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_reduce_sum_f32(0, src.buf_id, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_scale_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_scale_f32(0, src.buf_id, scalar, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub unsafe fn tile_clamp_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_clamp_f32(0, src.buf_id, lo, hi, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_attention_f32<const S: usize, const D: usize>(
    ...
    let buf_id = unsafe {
        ascend_tile_attention_f32(0, q.buf_id, k.buf_id, v.buf_id, S as u32, D as u32)
    };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_silu_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_silu_f32(0, src.buf_id, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_rope_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_rope_f32(0, src.buf_id, pos, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_causal_mask_f32<const S: usize>(
    ...
    let buf_id = unsafe { ascend_tile_causal_mask_f32(0, src.buf_id, S as u32, S as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_embedding_f32<const V: usize, const D: usize, const COUNT: usize>(
    ...
    let buf_id = unsafe {
        ascend_tile_embedding_f32(0, weight.buf_id, indices, V as u32, D as u32, COUNT as u32)
    };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_cross_entropy_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe {
        ascend_tile_cross_entropy_f32(0, logits.buf_id, targets, ROWS as u32, COLS as u32)
    };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_transpose_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_transpose_f32(0, src.buf_id, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_rsqrt_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_rsqrt_f32(0, src.buf_id, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_log_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_log_f32(0, src.buf_id, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_sigmoid_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_sigmoid_f32(0, src.buf_id, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_cast_f32_f16<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_cast_f32_f16(0, src.buf_id, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_cast_f16_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_cast_f16_f32(0, src.buf_id, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_concat_f32<const R: usize, const C1: usize, const C2: usize>(
    ...
    let buf_id = unsafe {
        ascend_tile_concat_f32(0, a.buf_id, b.buf_id, R as u32, C1 as u32, C2 as u32)
    };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_scatter_f32<const N: usize, const M: usize, const D: usize>(
    ...
    let buf_id = unsafe {
        ascend_tile_scatter_f32(0, src.buf_id, indices, N as u32, M as u32, D as u32)
    };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_gather_f32<const N: usize, const M: usize, const D: usize>(
    ...
    let buf_id = unsafe {
        ascend_tile_gather_f32(0, src.buf_id, indices, N as u32, M as u32, D as u32)
    };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_topk_f32<const R: usize, const C: usize, const K: usize>(
    ...
    let buf_id = unsafe {
        ascend_tile_topk_f32(0, src.buf_id, indices_out, R as u32, C as u32, K as u32)
    };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_matmul_f16<const M: usize, const K: usize, const N: usize>(
    ...
    let buf_id = unsafe {
        ascend_tile_matmul_f16(0, a.buf_id, b.buf_id, M as u32, K as u32, N as u32)
    };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_matmul_i8_acc_i32_dequant_f16<const M: usize, const K: usize, const N: usize>(
    ...
    let buf_id = unsafe {
        ascend_tile_matmul_i8_acc_i32_dequant_f16(
...
pub fn tile_load_i8<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_load_i8(gm, ROWS as u32, COLS as u32) };
    Tile {
        buf_id,
        _phantom: PhantomData,
    }
...
pub fn tile_store_i8<const ROWS: usize, const COLS: usize>(
    ...
    unsafe { ascend_tile_store_i8(gm, tile.buf_id, ROWS as u32, COLS as u32) };
}
...
pub fn tile_matmul_transposed_f32<const M: usize, const K: usize, const N: usize>(
    ...
    let buf_id = unsafe {
        ascend_tile_matmul_transposed_f32(0, a.buf_id, b.buf_id, M as u32, K as u32, N as u32)
    };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_matmul_transposed_f16<const M: usize, const K: usize, const N: usize>(
    ...
    let buf_id = unsafe {
        ascend_tile_matmul_transposed_f16(0, a.buf_id, b.buf_id, M as u32, K as u32, N as u32)
    };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_fill_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_fill_f32(0, scalar, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_max_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_max_f32(0, a.buf_id, b.buf_id, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_rms_norm_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_rms_norm_f32(0, src.buf_id, eps, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_quantize_f32_i8<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_quantize_f32_i8(0, src.buf_id, scale, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_dequantize_i8_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_dequantize_i8_f32(0, src.buf_id, scale, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_absmax_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_absmax_f32(0, src.buf_id, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_argmax_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_argmax_f32(0, src.buf_id, ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_sample_top_p_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe {
        ascend_tile_sample_top_p_f32(0, logits.buf_id, temperature, top_p, rng_seed, ROWS as u32, COLS as u32)
    };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_draft_verify_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe {
        ascend_tile_draft_verify_f32(0, draft_tokens.buf_id, target_logits.buf_id, ROWS as u32, COLS as u32)
    };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_load_f16<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_load_f16(gm, ROWS as u32, COLS as u32) };
    Tile {
        buf_id,
        _phantom: PhantomData,
    }
...
pub fn tile_store_f16<const ROWS: usize, const COLS: usize>(
    ...
    unsafe { ascend_tile_store_f16(gm, tile.buf_id, ROWS as u32, COLS as u32) };
}
...
pub fn tile_add_f16<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_add_f16(0, a.buf_id, b.buf_id, ROWS as u32, COLS as u32) };
    Tile {
        buf_id,
        _phantom: PhantomData,
    }
...
pub fn tile_softmax_f16<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_softmax_f16(0, src.buf_id, ROWS as u32, COLS as u32) };
    Tile {
        buf_id,
        _phantom: PhantomData,
    }
...
pub fn tile_matvec_f16<const N: usize, const K: usize>(
    ...
    let buf_id = unsafe { ascend_tile_matvec_f16(0, a.buf_id, w.buf_id, N as u32, K as u32) };
    Tile {
        buf_id,
        _phantom: PhantomData,
    }
...
pub fn tile_matvec_f32<const N: usize, const K: usize>(
    ...
    let buf_id = unsafe { ascend_tile_matvec_f32(0, a.buf_id, w.buf_id, N as u32, K as u32) };
    Tile {
        buf_id,
        _phantom: PhantomData,
    }
...
pub fn tile_matvec_f16_bias<const N: usize, const K: usize>(
    ...
    let buf_id = unsafe { ascend_tile_matvec_f16_bias(0, a.buf_id, w.buf_id, bias.buf_id, N as u32, K as u32) };
    Tile {
        buf_id,
        _phantom: PhantomData,
    }
...
pub fn tile_rope_inplace_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_rope_inplace_f32(0, x.buf_id, ROWS as u32, COLS as u32) };
    Tile {
        buf_id,
        _phantom: PhantomData,
    }
...
pub fn tile_kv_cache_update_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_kv_cache_update_f32(0, src.buf_id, ROWS as u32, COLS as u32) };
    Tile {
        buf_id,
        _phantom: PhantomData,
    }
...
pub fn tile_attention_decode_f32<const NH: usize, const DH: usize>(
    ...
    let buf_id = unsafe { ascend_tile_attention_decode_f32(0, q.buf_id, k_cache.buf_id, v_cache.buf_id, NH as u32, DH as u32) };
    Tile {
        buf_id,
        _phantom: PhantomData,
    }
...
pub fn tile_store_u32<const ROWS: usize, const COLS: usize>(
    ...
    unsafe { ascend_tile_store_f32(gm as *mut f32, tile.buf_id, ROWS as u32, COLS as u32) };
}
...
pub fn tile_rope_prefill_f32<const NH: usize, const DH: usize>(
    ...
    let buf_id = unsafe { ascend_tile_rope_prefill_f32(0, x.buf_id, NH as u32, DH as u32) };
    Tile {
        buf_id,
        _phantom: PhantomData,
    }
...
pub fn tile_kv_cache_update_prefill_f32<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_kv_cache_update_prefill_f32(0, src.buf_id, ROWS as u32, COLS as u32) };
    Tile {
        buf_id,
        _phantom: PhantomData,
    }
...
pub fn tile_attention_prefill_f32<const NH: usize, const DH: usize>(
    ...
    let buf_id = unsafe { ascend_tile_attention_prefill_f32(0, q.buf_id, k_cache.buf_id, v_cache.buf_id, NH as u32, DH as u32) };
    Tile {
        buf_id,
        _phantom: PhantomData,
    }
...
pub fn tile_matvec_f16_add<const ROWS: usize, const COLS: usize>(
    ...
    let buf_id = unsafe { ascend_tile_matvec_f16_add(0, a.buf_id, b.buf_id, r.buf_id, ROWS as u32, COLS as u32) };
    Tile {
        buf_id,
        _phantom: PhantomData,
    }
...
pub fn tile_gate_up_silu_f16<const N: usize, const K: usize>(
    ...
    let buf_id = unsafe { ascend_tile_gate_up_silu_f16(0, a.buf_id, w_gate.buf_id, w_up.buf_id, N as u32, K as u32) };
    Tile {
        buf_id,
        _phantom: PhantomData,
    }
...
pub fn tile_load_view_f32<'a, const ROWS: usize, const COLS: usize>(
    ...
    let buf_id =
        unsafe { ascend_tile_load_f32(view.as_ptr(), ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_store_view_f32<'a, const ROWS: usize, const COLS: usize>(
    ...
    unsafe {
        ascend_tile_store_f32(view.as_mut_ptr(), tile.buf_id, ROWS as u32, COLS as u32)
    };
}
...
/// intrinsic level (delegates to `ascend_tile_load_f32`); the distinct
...
pub fn tile_load_view_f16<'a, const ROWS: usize, const COLS: usize>(
    ...
    let buf_id =
        unsafe { ascend_tile_load_f16(view.as_ptr(), ROWS as u32, COLS as u32) };
    Tile { buf_id, _phantom: PhantomData }
}
...
pub fn tile_store_view_f16<'a, const ROWS: usize, const COLS: usize>(
    ...
    unsafe {
        ascend_tile_store_f16(view.as_mut_ptr(), tile.buf_id, ROWS as u32, COLS as u32)
    };
}
